...
(function (p, t, h) {
  ...
  function z(a, b) {
    ...
    "+" === c
      ? (c = ["+"])
      : ((c = c.replace(/\+{2}/g, "+plus")), (c = c.split("+")));
    ...
    if (!d) {
      if (!n) {
        n = {};
        for (var h in m)
          (95 < h && 112 > h) || (m.hasOwnProperty(h) && (n[m[h]] = h));
      }
  ...
  function e(a) {
    ...
    function d(a, b, r, g, F, e) {
      ...
      for (l = 0; l < f._callbacks[a].length; ++l) {
        ...
        if ((g || !d.seq || n[d.seq] == d.level) && h == d.action) {
          var c;
          (c = "keypress" == h && !r.metaKey && !r.ctrlKey) ||
            ((c = d.modifiers),
            (c = b.sort().join(",") === c.sort().join(",")));
          c &&
            ((c = g && d.seq == g && d.level == e),
            ((!g && d.combo == F) || c) && f._callbacks[a].splice(l, 1),
            D.push(d));
        }
      }
      return D;
    ...
    function h(a, b, d, g) {
      f.stopCallback(b, b.target || b.srcElement, d, g) ||
        !1 !== a(b, d) ||
    ...
    function m(a, b, c, g, e) {
      ...
      1 < h.length
        ...
        : ((c = z(a, c)),
          ...
          d(c.key, c.modifiers, { type: c.action }, g, a, e),
      ...
      for (f = 0; f < g.length; ++f)
        g[f].seq
          ? g[f].level == l &&
            ((k = !0),
            (c[g[f].seq] = 1),
            h(g[f].callback, e, g[f].combo, g[f].seq))
          : k || h(g[f].callback, e, g[f].combo);
      g = "keypress" == e.type && q;
      e.type != w || v(a) || g || b(c);
      q = k && "keydown" == e.type;
    };
